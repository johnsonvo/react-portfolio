      ...
      <div className='z-30 basis-2/5 mt-12 md:mt-32'>
        ...
        >
          ...
          <p className='mt-10 mb-7 text-sm text-center md:text-start'>
            Lorem ipsum dolor sit amet, no tale expetendis nec, munere ancillae
            nec eu. Sed ei zril maluisset sententiae, ei graece labores fastidii
            eam, ea vitae accusam quo.
          </p>
        </motion.div>
